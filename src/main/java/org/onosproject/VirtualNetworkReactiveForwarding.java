...
public class VirtualNetworkReactiveForwarding {
    ...
    TenantId tId = TenantId.tenantId("1");
    DeviceId vDid1 = DeviceId.deviceId("vdev1");
    DeviceId vDid2 = DeviceId.deviceId("vdev2");
    PortNumber vPort11 = PortNumber.portNumber(1);
    PortNumber vPort12 = PortNumber.portNumber(2);
    PortNumber vPort21 = PortNumber.portNumber(1);
    PortNumber vPort22 = PortNumber.portNumber(2);
    VirtualNetwork vNet;

    private void createVn() {
        vnaService.registerTenantId(tId);
        vNet = vnaService.createVirtualNetwork(tId);

        vnaService.createVirtualDevice(vNet.id(), vDid1);
//        vnaService.createVirtualDevice(vNet.id(), vDid2);

        ConnectPoint pcp11 = new ConnectPoint(DeviceId.deviceId("of:0000000000000001"), PortNumber.portNumber(1));
        ConnectPoint pcp12 = new ConnectPoint(DeviceId.deviceId("of:0000000000000001"), PortNumber.portNumber(2));

        vnaService.createVirtualPort(vNet.id(), vDid1, vPort11, pcp11);
        vnaService.createVirtualPort(vNet.id(), vDid1, vPort12, pcp12);
//        vnaService.createVirtualPort(vNet.id(), vDid2, vPort21, null);
//        vnaService.createVirtualPort(vNet.id(), vDid2, vPort22, null);

//        ConnectPoint cp12 = new ConnectPoint(vDid1, vPort12);
//        ConnectPoint cp21 = new ConnectPoint(vDid2, vPort11);

//        vnaService.createVirtualLink(vNet.id(), cp12, cp21);
    }
    ...
    public void activate(ComponentContext context) {
        ...
        appId = coreService.registerApplication("org.onosproject.fwdvn");
